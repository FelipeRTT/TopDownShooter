...
quantidadeInimigosTotal = irandom_range(5,17);//definindo um valor aleatorio pra quantidade de inimigos
inimigoCriado = 0;//quando inimigo criado for = quantidade vai fazer o criando ser false
